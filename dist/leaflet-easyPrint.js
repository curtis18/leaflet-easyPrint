            ...
            !(function (e) {
                ...
                var h = (function () {
                        ...
                        function l(t) {
                            var e = 3e4;
                            return (
                                w.impl.options.cacheBust && (t += (/\?/.test(t) ? "&" : "?") + new Date().getTime()),
                    ...
                    w = { toSvg: n, toPng: o, toJpeg: r, toBlob: a, toPixelData: i, impl: { fontFaces: p, images: f, util: h, inliner: m, options: {} } };
                t.exports = w;
            })();
        }),
        i = t(function (t) {
    ...
    (L.Control.EasyPrint = L.Control.extend({
        ...
        onAdd: function () {
            (this.mapContainer = this._map.getContainer()),
                (this.options.sizeModes = this.options.sizeModes.map(function (t) {
                    return "Current" === t
                        ? { name: this.options.defaultSizeTitles.Current, className: "CurrentSize" }
                        : "A4Landscape" === t
                        ? { height: this._a4PageSize.height, width: this._a4PageSize.width, name: this.options.defaultSizeTitles.A4Landscape, className: "A4Landscape page" }
                        : "A4Portrait" === t
                        ? { height: this._a4PageSize.width, width: this._a4PageSize.height, name: this.options.defaultSizeTitles.A4Portrait, className: "A4Portrait page" }
                        : t;
                }, this));
        ...
        printMap: function (t, e) {
            e && (this.options.filename = e),
                ...
                (this.originalState = { mapWidth: this.mapContainer.style.width, widthWasAuto: !1, widthWasPercentage: !1, mapHeight: this.mapContainer.style.height, zoom: this._map.getZoom(), center: this._map.getCenter() }),
                "auto" === this.originalState.mapWidth
                    ? ((this.originalState.mapWidth = this._map.getSize().x + "px"), (this.originalState.widthWasAuto = !0))
                    : this.originalState.mapWidth.includes("%") &&
                      ((this.originalState.percentageWidth = this.originalState.mapWidth), (this.originalState.widthWasPercentage = !0), (this.originalState.mapWidth = this._map.getSize().x + "px")),
        ...
        _createImagePlaceholder: function (t) {
            var e = this;
            n.toPng(this.mapContainer, { width: parseInt(this.originalState.mapWidth.replace("px")), height: parseInt(this.originalState.mapHeight.replace("px")) })
                .then(function (n) {
        ...
        _printOpertion: function (t) {
            ...
            ((this.originalState.widthWasAuto && "CurrentSize" === t) || (this.originalState.widthWasPercentage && "CurrentSize" === t)) && (o = this.originalState.mapWidth),
                n
                    .toPng(e.mapContainer, { width: parseInt(o), height: parseInt(e.mapContainer.style.height.replace("px")) })
                    .then(function (t) {
                        ...
                        e.options.exportOnly ? i.saveAs(n, e.options.filename + ".png") : e._sendToBrowserPrint(t, e.orientation),
                            ...
                            e.outerContainer &&
                                (e.originalState.widthWasAuto
                                    ...
                                    ? (e.mapContainer.style.width = e.originalState.percentageWidth)
